    ...
    <div className="md:hidden font-Inter py-[26px] px-[42px] flex justify-between">
      ...
      <div>
        <Menu as="div" className="relative z-50 inline-block text-left">
          ...
          >
            <Menu.Items className="z-40 absolute right-0 mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
