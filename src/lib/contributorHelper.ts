...
function reduce(array: string[], combine: (array: string[], value: any) => string[], start: string[]) {
  let current = start;
...
function filterForHumans(contributors: string[]) {
...
async function fetchContributorNames(contributors: string[]) {
