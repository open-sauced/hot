...
describe("Test: isValidRepoUrl()", () => {
  ...
  test("Case insensitive test", () => {
    expect(isValidRepoUrl("Http://github.com/owner_name/repo_name").isValid).toBe(true);
    expect(isValidRepoUrl("Https://github.com/owner_name/repo_name").isValid).toBe(true);
    expect(isValidRepoUrl("http://GITHUB.com/owner_name/repo_name").isValid).toBe(true);
    expect(isValidRepoUrl("http://github.com/ owner_name / repo_name ").isValid).toBe(true);
  });
});
